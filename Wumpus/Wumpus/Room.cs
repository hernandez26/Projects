...
namespace Wumpus
{
    class Room
    {
        ...
        public bool CanSmellWumpus()
        {
            ...
            if (neighbors[0].hasWumpus)
            {
                return true;
            }
            if (neighbors[1].hasWumpus)
            {
                return true;
            }
            if (neighbors[2].hasWumpus)
            {
                return true;
            }
            return false;
        ...
        public bool HasDraft()
        {
            ...
            //flag in any of neighbors
            //is set to true. Otherwise, return false.
            if (neighbors[0].hasPit)
            {
                return true;
            }
            if (neighbors[1].hasPit)
            {
                return true;
            }
            if (neighbors[2].hasPit)
            {
                return true;
            }
            return false;
        ...
        public bool HearsBats()
        {
            ...
            if (neighbors[0].hasBats)
            {
                return true;
            }
            if (neighbors[1].hasBats)
            {
                return true;
            }
            if (neighbors[2].hasBats)
            {
                return true;
            }
            return false;
